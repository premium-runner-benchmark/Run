...
export type Response_addh5p_201 = {
    analytics_id?: string;
    h5p_id?: number;
} & {
    [key: string]: any;
...
export type Response_getAnalytics_200 = {
    _id?: string;
    accessed_at?: number;
    created_at?: number;
...
export class LumiRunAPI {
    ...
    */
    ...
    addh5p(
        ...
        | ResponseWithBody<201, Response_addh5p_201>
    ...
    */
    getAnalytics(
        ...
        | ResponseWithBody<200, Response_getAnalytics_200>
